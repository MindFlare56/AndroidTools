...
abstract class NFCReaderFragment extends Fragment {
    ...
    protected abstract View inflateLayout(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState);
