...
class UriRecord implements ParsedNdefRecord {
    ...
    /**
     * NFCReaderFragment Forum "URI Record Type Definition"
     *
     * This is a mapping of "URI Identifier Codes" to URI string prefixes,
     * per section 3.2.2 of the NFCReaderFragment Forum URI Record Type Definition document.
     */
    ...
    private static UriRecord parseWellKnown(NdefRecord record) {
         ...
         * NFCReaderFragment Forum "URI Record Type Definition" section 3.2.2.
         *
